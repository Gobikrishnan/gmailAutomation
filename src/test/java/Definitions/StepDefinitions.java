...
public class StepDefinitions {
	...
	public void clickNextButton() throws Exception{
	 ...
	 public void loggedinAs(String userName) throws Exception{
		 WebElement element = driver.findElement(By.xpath("/html/body/div[7]/div[3]/div/div[1]/div[4]/div[1]/div[1]/div[1]/div/div[4]/div[1]/a"));
	  ...
	  public void addBody(String bodyMessage) throws Exception{
		 ...
		 //printbody.sendKeys(bodyMessage);
		  //driver.switchTo().defaultContent();
		 // driver.findElement(By.cssSelector("textarea[class='Am Al editable LW-avf']")).sendKeys(bodyMessage);
	  ...
	  public void checkSentMailSubject(String sentMailSubject) throws Exception{
		  WebElement element = driver.findElement(By.xpath("/html/body/div[7]/div[3]/div/div[2]/div[1]/div[2]/div/div/div/div[2]/div[1]/div[1]/div/div[2]/div[4]/div[1]/div/table/tbody/tr/td[6]/div/div/div/span[1]"));
	   ...
	   public void logout() throws Exception{
			// driver.findElement(By.xpath("/html/body/div[7]/div[3]/div/div[1]/div[4]/div[1]/div[1]/div[1]/div/div[4]/div[1]/a")).click();
			// driver.findElement(By.xpath("//div[contains(text(),'Sign out')]")).click();
		   
		   driver.findElement(By.xpath("/html/body/div[7]/div[3]/div/div[1]/div[4]/div[1]/div[1]/div[1]/div/div[4]/div[1]/a")).click();
		   Thread.sleep(3000);
		   driver.findElement(By.className("gb_nd")).click(); // To click the sign out button
		  }
